...
const stayFields = ['options', 'activeOptionId', 'id', 'title', 'startDate', 'endDate', 'booking', 'currentFirstChoice', 'currentFirstChoiceUrl', 'currentAlternative', 'currentAlternativeUrl', 'currentFirstChoiceNotes', 'currentAlternativeNotes', 'firstChoice', 'firstChoiceUrl', 'alternative', 'alternativeUrl', 'parking', 'reviewedAt', 'motorcycleParking', 'reviewNote', 'reviewSources', 'note'];
